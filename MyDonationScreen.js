...
export defualt class MyDonationScreen extends Component {
    constructor(){
        super()
        this.state = {
    ...
    getDonorDetails=()=>{
        ...
        .then(()=>{
            Snapshot.forEach((doc) => {
                this.setState({
                    "donorName" doc.data().first_name + " " + doc.data().last__name
                })
            });
        })
    }
    ...
    sendbook=(bookDetails)=>{
        if(bookDetails.request_status === "Book sent"){
            ...
            db.collection("all-donations").doc(bookDetails.doc_id).update({
        ...
        .then((snapshot) => {
            snapshot.forEach((doc) => {
                ...
                if(requestStatus === "Book Sent"){
                    ...
                    message = this.state.donorName + " has shown interest in donationg the book"
                }
 ...
 keyExtractor = Drawer (Item, index) => index.toString()
